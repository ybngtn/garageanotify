                        ...
                        if v.stored == true or v.stored == 1 then
                            ...
                            table.insert(elements, {
                                ...
                                onSelect = function(args)
                                    exports['dopeNotify']:Alert("Garáž", "Vaše Vozidlo bylo odtaženo", 4000, 'info')
				--exports['mythic_notify']:SendAlert('impounded', 'Vaše Vozidlo bylo odtaženo')
                                end,
                            })
                        end
                    end
...
RegisterCommand('savevehicle', function()
    ...
    ESX.TriggerServerCallback('lunar_garage:saveVehicle', function(success) 
        if success then
            ...
            exports['dopeNotify']:Alert("Garáž", "Vaše Vozidlo bylo uspěšně Uloženo", 4000, 'info')
				--exports['mythic_notify']:SendAlert('save_success', 'Vaše Vozidlo bylo uspěšně Uloženo')
        else
            exports['dopeNotify']:Alert("Garáž", "Tohle Vozidlo vám nepatří!", 4000, 'info')
				--exports['mythic_notify']:SendAlert('not_yours', 'Tohle Vozidlo vám nepatří!')
        end
    end, props)
end, false)
...
function RetrieveVehicle(props)
    ...
    ESX.TriggerServerCallback('lunar_garage:returnVehicle', function(success) 
        if success then
            ...
            exports['dopeNotify']:Alert("Garáž", "Nemáš Dostatek peněz", 4000, 'info')
				--exports['mythic_notify']:SendAlert('not_enough_money', 'Nemáš Dostatek peněz')
        end
    end, props.plate)
end
